...
function openTab(evt, tabType) {
    ...
    //document.getElementById("tabCount").textContent = "" + document.getElementById(tabType).childElementCount + "";
}
...
async function startUpList(){
    await refreshList();
    /*if (listDefaultPreference==1){
        document.getElementById("tabCount").textContent = "" + document.getElementById("Watching").childElementCount + "";
    }
    else if(listDefaultPreference==2){
        document.getElementById("tabCount").textContent = "" + document.getElementById("Reading").childElementCount + "";
    }
    else if(listDefaultPreference==3){
        document.getElementById("tabCount").textContent = "" + document.getElementById("Reading2").childElementCount + "";
    }
    else if(listDefaultPreference==4){
        document.getElementById("tabCount").textContent = "" + document.getElementById("Playing").childElementCount + "";
    }
    else{
        document.getElementById("tabCount").textContent = "" + document.getElementById("Watching").childElementCount + "";
    }*/
