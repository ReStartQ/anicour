...
import EntryInputNotOnList from './entryInput/notOnList/EntryInputNotOnList';
...
export default function AdvancedMainNOL({ props }: any) {
  ...
  return (
    <>
      {myAdvancedMedia.advancedMedia.id !== -1 ? (
        <Paper
          elevation={0}
          square
          sx={{
